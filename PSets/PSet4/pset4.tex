...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{proof}
            ...
            The steady-state approximation would not be valid in \fbox{Scenarios \textbf{i} and \textbf{iii}.}\par
            ...
            Notes: If \ce{A} is more stable than \ce{B}, then the SSA is valid; the converse is not necessarily true.
        \end{proof}
        ...
        \begin{proof}
            The quasi-equilibrium assumption would not be valid in \fbox{Scenarios \textbf{iii}, \textbf{iv}, and \textbf{v}.} The quasi-equilibrium assumption is only valid when $k_{-1}>k_2$.
        \end{proof}
        ...
        \begin{proof}
            When the first step is rate-determining, we'll definitely see a KIE. But even when it is not, KIEs will affect $\cnc{\textbf{B}}$, altering the rate of the RDS! Thus, \fbox{all scenarios} display KIEs. Answers to all questions in \textcite{bib:SsaQea}.
        \end{proof}
    \end{enumerate}
    \pagebreak
    ...
    \begin{enumerate}
        ...
        \begin{proof}
            ...
            In the case of low concentrations of \textbf{2}, the rate law also collapses to an expression that is first-order in $\cnc{\textbf{2}}$, consistent with the plot.\par
