...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Their respective inversion barriers are \SIrange[per-mode=symbol]{1}{2}{\kilo\calorie\per\mole}, \SI[per-mode=symbol]{5}{\kilo\calorie\per\mole}, \SI[per-mode=symbol]{50}{\kilo\calorie\per\mole}, and \SI[per-mode=symbol]{35}{\kilo\calorie\per\mole}.
