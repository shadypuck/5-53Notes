...
\begin{itemize}
    ...
    \begin{itemize}
        \item Example: \chemfig{H_2\charge{[extra sep=2pt,.radius=0.1ex]0=\:}{C}}\ \ favors the triplet state by \SI[per-mode=symbol]{8.5}{\kilo\calorie\per\mole}.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item Example: \chemfig{F_2\charge{[extra sep=2pt,.radius=0.1ex]0=\:}{C}}\ \ favors the singlet state by $\sim\SI[per-mode=symbol]{50}{\kilo\calorie\per\mole}$.
    \end{itemize}
