...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Often, $k_{\ce{A}}/k_{\ce{B}}$ is equal to the relative rate $k_\text{rel}$ of the two reactions (\ce{SM -> A} and \ce{SM -> B}).
            \begin{itemize}
                \item If \ce{A} and \ce{B} are enantiomers or diastereomers, $k_\text{rel}$ often equals \textbf{er} or \textbf{dr}, respectively.
    ...
    \begin{itemize}
        ...
        \item However, \ce{SM_A} has hydrogens antiperiplanar to it, so it reacts faster ($k_\text{rel}=70$).
    ...
    \end{figure}
    \begin{itemize}
        \item In radical chlorination: \ce{C-H} has a BDE of \SI[per-mode=symbol]{98}{\kilo\calorie\per\mole} and \ce{H-Cl} has a BDE of \SI[per-mode=symbol]{103}{\kilo\calorie\per\mole}.
        \begin{itemize}
        ...
        \end{itemize}
        \item In radical bromination: \ce{C-H} has a BDE of \SI[per-mode=symbol]{98}{\kilo\calorie\per\mole} and \ce{H-Br} has a BDE of \SI[per-mode=symbol]{87}{\kilo\calorie\per\mole}.
        \begin{itemize}
            \item Thus, the reaction is endothermic with $\Delta H=\SI[per-mode=symbol]{11}{\kilo\calorie\per\mole}$.
